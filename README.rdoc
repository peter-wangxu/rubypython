...
Note that, this is a fork of {RubyPython}[https://github.com/halostatue/rubypython],
since it's not activily maintained. I have to rename/publish the package via a new
name {pybridge}[https://rubygems.org/gems/pybridge].

If the RubyPython became active again, I am welling to merge this back to it:).
== Where
...
* {GitHub forked by peter-wangxu}[https://github.com/peter-wangxu/rubypython]
